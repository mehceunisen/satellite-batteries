% NiCd Battery Charge/Discharge Simulation

% Parameters
capacity = 1000; % Battery capacity in mAh (milliampere-hour)
initial_SOC = 50; % Initial State of Charge in percentage (0-100)
charge_C_rate = 0.5; % Charging rate in C-rate (e.g., 0.5C means full charge in 2 hours)
discharge_C_rate = 0.2; % Discharging rate in C-rate (e.g., 0.2C means full discharge in 5 hours)
time_step = 1; % Time step in minutes
total_time = 240; % Total simulation time in minutes
charge_efficiency = 0.9; % Charging efficiency (90%)
...
title('NiCd Battery Charge/Discharge Simulation');
grid on;
